...
```c
{% include samples/sdl/main.c %}
```

**CMakeLists.txt**

```cmake
{% include samples/sdl/CMakeLists.txt %}
``````
...
```c
{% include samples/sdl_mixer/main.c %}
```

**CMakeLists.txt**

```cmake
{% include samples/sdl_mixer/CMakeLists.txt %}
``````
...
```c
{% include samples/sdl_ttf/main.c %}
```

**CMakeLists.txt**

```cmake
{% include samples/sdl_ttf/CMakeLists.txt %}
``````
...
Documentation for SDL_ttf can be found <a href="https://wiki.libsdl.org/SDL3_ttf/FrontPage">here</a>.
